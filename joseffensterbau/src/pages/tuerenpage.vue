    ...
    <v-main class="pa-0">
      ...
      <section class="hero">
        <v-carousel class="hero-carousel" hide-delimiters show-arrows="hover" cycle height="60svh" transition="fade-transition">
          <v-carousel-item v-for="i in 3" :key="i">
            <v-img src="" alt="Hero Slide" cover class="hero-img" />
            <div class="hero-overlay">
              <h2 class="hero-title">Türenneuheiten {{ i }}</h2>
              <p class="hero-sub">Design, Sicherheit und beste Dämmwerte für jeden Eingang.</p>
            </div>
          </v-carousel-item>
        </v-carousel>
      </section>
        ...
        <v-container class="section-container">
          <v-row align="center" justify="space-between">
            <v-col cols="12" md="6" class="section-media">
              <v-img src="" alt="Holz Haustüren" cover class="section-img" />
            </v-col>
            <v-col cols="12" md="5" class="section-body">
              ...
              <v-btn variant="text" class="section-link" append-icon="mdi-chevron-right">Mehr…</v-btn>
            </v-col>
          </v-row>
        </v-container>
      </section>
        ...
        <v-container class="section-container">
          <v-row align="center" justify="space-between">
            ...
            <v-col cols="12" md="6" class="section-media order-md-2">
              <v-img src="" alt="Holz‑Alu Haustüren" cover class="section-img" />
            </v-col>
          </v-row>
        </v-container>
      </section>
      ...
      <section class="section section--light">
        <v-container class="section-container">
          <v-row align="center" justify="space-between">
            <v-col cols="12" md="6" class="section-media">
              <v-img src="" alt="Holz/Stein Haustüren" cover class="section-img" />
            </v-col>
            <v-col cols="12" md="5" class="section-body">
      ...
      <section class="section section--alt">
        <v-container class="section-container">
          <v-row align="center" justify="space-between">
            ...
            <v-col cols="12" md="6" class="section-media order-md-2">
              <v-img src="" alt="Aluminium Haustüren" cover class="section-img" />
            </v-col>
          </v-row>
        </v-container>
      </section>
        ...
        <v-container class="section-container">
          <v-row>
            ...
            <v-col cols="12">
              ...
              >
                <v-img
                  src="https://placehold.co/1280x600/png?text=Konfigurator+Vorschau"
...
<script setup>
// No logic yet; images and links can be wired later
</script>
...
.section-img { height: 360px; background: #e5e7eb; }
